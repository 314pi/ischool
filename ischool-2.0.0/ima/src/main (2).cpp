/*
 * main.cpp - main-file for iSCHOOL Master Application
 *
...
// good old main-function... initializes qt-app and starts iSCHOOL
int main( int argc, char * * argv )
{
	...
	while( argc > 1 && arg_it.hasNext() )
	{
		...
		if( a == "-rctrl" && arg_it.hasNext() )
		{
			...
			{
				ilog_failed( "IschoolCore::initAuthentication()" );
				return -1;
			}
