...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:12pt; font-weight:600; font-style:italic;\">Welcome to iTALC!</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        ...
        label5->setText(QApplication::translate("Overview", "Of course you can configure iTALC. This is usually done using the configuration-workspace.", 0, QApplication::UnicodeUTF8));
        aboutButton->setText(QApplication::translate("Overview", "About iTALC", 0, QApplication::UnicodeUTF8));
        Q_UNUSED(Overview);
    } // retranslateUi
