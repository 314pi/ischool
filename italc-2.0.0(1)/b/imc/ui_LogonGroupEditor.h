...
public:
    ...
    void retranslateUi(QDialog *LogonGroupEditor)
    {
        ...
        label_3->setText(QApplication::translate("LogonGroupEditor", "Please add the groups whose members should be allowed to access computers in your iTALC network.", 0, QApplication::UnicodeUTF8));
        ...
        label_6->setText(QApplication::translate("LogonGroupEditor", "Groups with iTALC privileges", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
