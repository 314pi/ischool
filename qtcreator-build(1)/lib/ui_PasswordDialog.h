...
public:
    ...
    {
        PasswordDialog->setWindowTitle(QApplication::translate("PasswordDialog", "iTALC Logon", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("PasswordDialog", "Please enter your username and password in order to access iTALC clients.", 0, QApplication::UnicodeUTF8));
