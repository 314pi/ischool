...
**
** Created: Thu May 10 14:32:41 2012
...
public:
    ...
    void retranslateUi(QDialog *ClientSettingsDialog)
    {
        ...
        hostnameEdit->setToolTip(QApplication::translate("ClientSettingsDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:Sans Serif; font-size:9pt; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">enter an IP-address or hostname under which iTALC can reach the client (use ':' for specifying an optional port-number)</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("ClientSettingsDialog", "Name", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        nameEdit->setToolTip(QApplication::translate("ClientSettingsDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:Sans Serif; font-size:9pt; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Optional nickname of the host which is displayed in iTALC.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
