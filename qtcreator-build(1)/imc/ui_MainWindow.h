...
**
** Created: Thu May 10 14:33:10 2012
...
public:
    ...
    QWidget *italcServerSettingsPage;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionAboutItalc = new QAction(MainWindow);
        actionAboutItalc->setObjectName(QString::fromUtf8("actionAboutItalc"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resources/info.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAboutItalc->setIcon(icon3);
...
""));
        ...
        italcServerSettingsPage = new QWidget();
        italcServerSettingsPage->setObjectName(QString::fromUtf8("italcServerSettingsPage"));
        verticalLayout_6 = new QVBoxLayout(italcServerSettingsPage);
        verticalLayout_6->setSpacing(10);
        verticalLayout_6->setObjectName(QString::fromUtf8("verticalLayout_6"));
        groupBox_6 = new QGroupBox(italcServerSettingsPage);
        ...
        groupBox_9 = new QGroupBox(italcServerSettingsPage);
        ...
        groupBox_8 = new QGroupBox(italcServerSettingsPage);
        ...
        configPages->addWidget(italcServerSettingsPage);
        ...
        menu_Help->addAction(actionAboutItalc);
        ...
        QObject::connect(actionAboutItalc, SIGNAL(triggered()), MainWindow, SLOT(aboutItalc()));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "iTALC Management Console", 0, QApplication::UnicodeUTF8));
        ...
        actionAboutItalc->setText(QApplication::translate("MainWindow", "About iTALC", 0, QApplication::UnicodeUTF8));
        ...
        ___qlistwidgetitem1->setText(QApplication::translate("MainWindow", "iTALC Server", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_3->setTitle(QApplication::translate("MainWindow", "iTALC Service", 0, QApplication::UnicodeUTF8));
        ...
        demoServerBackend->insertItems(0, QStringList()
         ...
         << QApplication::translate("MainWindow", "iTALC 1 demo server", 0, QApplication::UnicodeUTF8)
        );
        ...
        label_3->setText(QApplication::translate("MainWindow", "You can configure iTALC to ask the user for permission to access the desktop when using certain authentication methods.", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_10->setTitle(QApplication::translate("MainWindow", "Debugging iTALC", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("MainWindow", "When encountering bugs or other misbehaviour in iTALC it is important to inform the developers about them, so that the bugs can be fixed in future releases. This page allows you to submit a helpful bug report easily.\n"
"\n"
"If the bug is not reproducible, skip step 1) - 3).", 0, QApplication::UnicodeUTF8));
        ...
        label_24->setText(QApplication::translate("MainWindow", "Go to the <a href=\"http://sourceforge.net/tracker/?group_id=132465&amp;atid=724375\">iTALC bug tracker</a>, open a new bug, describe what you did in step 3) and attach the file you saved in step 4).</p>\n"
"<br/>\n"
"<br/>\n"
