...
public:
    ...
    {
        KeyFileAssistant->setWindowTitle(QApplication::translate("KeyFileAssistant", "iTALC Access Key Assistant", 0, QApplication::UnicodeUTF8));
        welcomePage->setTitle(QApplication::translate("KeyFileAssistant", "Create/import iTALC access keys", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("KeyFileAssistant", "This assistant will help you to create or import iTALC access keys.", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("KeyFileAssistant", "How does it work?", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("KeyFileAssistant", "iTALC access keys consist of two parts belonging together, a private and a public key part.\n"
"\n"
